		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="E3E3E3" align="right">
	      <tr>
	        ...
	        <div class="innerpage-breadcrum">
				...
				<a href="javascript:void(0);" class="select">Default Earning Code</a>
				<span style="float: right">
					<a href="#" onclick="javascript:reset()" class="easyui-linkbutton" iconCls="icon-add">Add Default Earning Code</a>
	    ...
	    <table width="100%" border="0" cellspacing="1" cellpadding="5" class="data-table-new" align="right">
	      ...
	      <tr>
		     <td style="width:20%" nowrap="nowrap">
    			<label>Default Earning Code</label><span class="mandatory">*</span>
    		 </td>
	      ...
	      <tr>
	      	<td colspan="8">
	      		<table id="dataTable"  class="easyui-datagrid"  title="Default Earning Code Details Table"  style="width:100%;height:270px;table-layout: fixed;"
						...
						<thead>
							<tr>
								...
								<th data-options="field:'value',width:100" formatter="formatDetail">Default Earning Code</th>
...
$(document).ready(function(){
	getDetails('getDefaultEarningCodeDetails.htm');
});
function save(){
	if($('#mapdto').valid()){
		loading();
		...
		$.ajax({
			url:"saveDefaultEarningCode.htm",
			type: "post",
...
function reset(){
	document.forms[0].action='defaultEarningCode.htm';
...
function displayExistRecord(id){
	getDetailsById('getDefaultEarningCodeDetailsById.htm?id='+id);
}
</script>

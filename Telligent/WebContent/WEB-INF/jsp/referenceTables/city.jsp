 	...
 	<div style="margin:0px;cursor:auto;" id="tab">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="E3E3E3" align="right">
	      <tr>
	        ...
	        <div class="innerpage-breadcrum">
				...
				<a href="javascript:void(0);" class="select">City</a>
				<span style="float: right">
				<a href="#" onclick="javascript:reset()" class="easyui-linkbutton" iconCls="icon-add">Add City</a>
	    ...
	    <table width="100%" border="0" cellspacing="1" cellpadding="5" class="data-table-new" align="right">
	      ...
	      <tr>
    		 ...
    		 <td>
    		 	<form:select path="refId" cssClass="required">
    		 		<form:option value="">Select State</form:option>
    		 		<form:options items="${stateList}" itemValue="id" itemLabel="value"/>
    		 	</form:select>
    		 </td>
	      </tr>
	      <tr>
	      ...
	      <tr>
	      	<td colspan="8">
	      		<table id="dataTable"  class="easyui-datagrid"  title="City Details Table"  style="width:100%;height:270px;table-layout: fixed;"
						...
						<thead>
							<tr>
								...
								<th data-options="field:'value',width:100" formatter="formatDetail">City</th>
								<th data-options="field:'refId',width:100">State</th>
...
$(document).ready(function(){
	getDetails('getCityDetailsRef.htm');
});
function save(){
	if($('#mapdto').valid()){
		loading();
...
function reset(){
	document.forms[0].action='city.htm';
...
function displayExistRecord(id){
	getDetailsById('getCityDetailsRefById.htm?id='+id);
}
</script>

		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="E3E3E3" align="right">
	      <tr>
	        ...
	        <div class="innerpage-breadcrum">
				...
				<a href="javascript:void(0);" class="select">Status Reason</a>
				<span style="float: right">
				<a href="#" onclick="javascript:reset()" class="easyui-linkbutton" iconCls="icon-add">Add Status Reason</a>
	    ...
	    <table width="100%" border="0" cellspacing="1" cellpadding="5" class="data-table-new" align="right">
	      ...
	      <tr>
		     <td style="width:20%" nowrap="nowrap">
    			<label>Status Reason</label><span class="mandatory">*</span>
    		 </td>
	      ...
	      <tr>
	      	<td colspan="8">
	      		<table id="dataTable"  class="easyui-datagrid"  title="Status Reason Details Table"  style="width:100%;height:270px;table-layout: fixed;"
						...
						<thead>
							<tr>
								...
								<th data-options="field:'value',width:100" formatter="formatDetail">Status Reason</th>
...
$(document).ready(function(){
	getDetails('getStatusReasonDetails.htm');
});
function save(){
	if($('#mapdto').valid()){
		loading();
...
function reset(){
	document.forms[0].action='statusReason.htm';
...
function displayExistRecord(id){
	getDetailsById('getStatusReasonDetailsById.htm?id='+id);
}
</script>

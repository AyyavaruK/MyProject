		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="E3E3E3" align="right">
	      <tr>
	        ...
	        <div class="innerpage-breadcrum">
				...
				<a href="javascript:void(0);" class="select">Org4</a>
				<span style="float: right">
				<a href="#" onclick="javascript:reset()" class="easyui-linkbutton" iconCls="icon-add">Add Org4</a>
	    ...
	    <table width="100%" border="0" cellspacing="1" cellpadding="5" class="data-table-new" align="right">
	      ...
	      <tr>
		     <td style="width:20%" nowrap="nowrap">
    			<label>Org4</label><span class="mandatory">*</span>
    		 </td>
	      ...
	      <tr>
	      	<td colspan="8">
	      		<table id="dataTable"  class="easyui-datagrid"  title="Org4 Details Table"  style="width:100%;height:270px;table-layout: fixed;"
						...
						<thead>
							<tr>
								...
								<th data-options="field:'value',width:100" formatter="formatDetail">Org4</th>
...
function reset(){
	document.forms[0].action='org4.htm';
...
function displayExistRecord(id){
	getDetailsById('getOrg4DetailsById.htm?id='+id);
}
</script>
